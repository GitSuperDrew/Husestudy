            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        <li class="active">
                            <a ><i class="icon-chevron-right"></i> 管理选项</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/college/list.jsp"><i class="icon-chevron-right"></i> 学院管理</a>
                        </li>
                        <li>
                            <a href=""><i class="icon-chevron-right"></i> 专业管理</a>
                        </li>
                        <li>
                            <a href=""><i class="icon-chevron-right"></i> 用户管理</a>
                        </li>
                        <li>
                            <a href=""><i class="icon-chevron-right"></i> 作品管理</a>
                        </li>
                        <li>
                            <a href=""><i class="icon-chevron-right"></i> 收藏管理</a>
                        </li>
                        <li>
                            <a href=""><i class="icon-chevron-right"></i> 评论管理</a>
                        </li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">内容显示区</div>
