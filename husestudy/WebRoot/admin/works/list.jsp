				...
				<div class="block-content collapse in">
					<div class="span12">
						...
						<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
							...
							<tbody>
							<s:iterator var="w" value="wList" status ="status">
								<tr class="odd gradeA" onmouseover="this.style.backgroundColor='white'">
									<td style="cursor:hand" align="center"><s:property value="#w.wid"/></td>
									<td style="cursor:hand" align="center"><s:property value="#w.wname"/></td>
									<td style="cursor:hand;" align="center"><s:property value="#w.wcontent"/></td>
									<td style="cursor:hand" align="center">
										<img width="40" height="45" src="${ pageContext.request.contextPath }/<s:property value="#w.wimage"/>">
									</td>
									<td style="cursor:hand" align="center">
										<img width="40" height="45" src="${ pageContext.request.contextPath }/<s:property value="#w.wvedio"/>">
									</td>
									<td style="cursor:hand" align="center"><s:property value="%{getText('{0,date,yyyy-MM-dd HH:mm:ss}',{#w.wdate})}"/></td>
									<td style="cursor:hand" align="center"><s:property value="#w.user.username"/></td>
									
									<td align="center" style="HEIGHT: 22px">
										<a href="${ pageContext.request.contextPath }/adminWorks_delete.action?wid=<s:property value="#w.wid"/>" onclick="return confirm('确定要删除吗？')">
