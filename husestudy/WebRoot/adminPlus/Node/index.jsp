...
<html>
	...
	<body>
		<form class="form-inline definewidth m20" action="${pageContext.request.contextPath}/adminPlus/Node/index.jsp" method="get">
			机构名称：
		...
		<table class="table table-bordered table-hover definewidth m10">
			...
			<tr>
				...
				<td>1</td>
				<td>
					<a href="${pageContext.request.contextPath}/adminPlus/Node/edit.jsp">编辑</a>
		...
		<div class="inline pull-right page">
			10122 条记录 1/507 页
			<a href='#'>下一页</a> <span class='current'>1</span>
			<a href='#'>2</a>
...
<script>
	$(function() {
		$('#addnew').click(function() {
			window.location.href = "${pageContext.request.contextPath}/adminPlus/Node/add.jsp";
		});
	});

	function del(id) {
		if(confirm("确定要删除吗？")) {
			var url = "${pageContext.request.contextPath}/adminPlus/Node/index.jsp";
