...
<html>
	...
	<body>
		<form class="form-inline definewidth m20" action="${pageContext.request.contextPath}/adminPlus/Role/index.jsp" method="get">
			角色名称：
		...
		<table class="table table-bordered table-hover definewidth m10">
			...
			<tr>
				...
				<td>1</td>
				<td>
					<a href="${pageContext.request.contextPath}/adminPlus/Role/edit.jsp">编辑</a>
...
<script>
	$(function() {
		$('#addnew').click(function() {
			window.location.href = "${pageContext.request.contextPath}/adminPlus/Role/add.jsp";
		});
	});

	function del(id) {
		if(confirm("确定要删除吗？")) {
			var url = "${pageContext.request.contextPath}/adminPlus/Role/index.jsp";
