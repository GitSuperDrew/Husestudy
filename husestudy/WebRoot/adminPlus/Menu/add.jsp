...
<html>
	...
	<body>
		<form action="${pageContext.request.contextPath}/adminPlus/Menu/index.jsp" method="post" class="definewidth m20">
...
<script>
	$(function() {
		$('#backid').click(function() {
			window.location.href = "${pageContext.request.contextPath}/adminPlus/Menu/index.jsp";
		});
