...
<body>
<form class="form-inline definewidth m20" action="${pageContext.request.contextPath}/adminPlus/Menu/index.jsp" method="get">
    菜单名称：
    ...
    <tr>
        ...
        <th>管理操作</th>
	     ...
	     <tr>
            ...
            <td><a href="${pageContext.request.contextPath}/adminPlus/Menu/edit.jsp">编辑</a></td>
        </tr>
        <tr>
                <td>机构管理</td>
                <td>Admin</td>
...
<script>
    $(function () {
		...
		$('#addnew').click(function(){
				...
				window.location.href="${pageContext.request.contextPath}/adminPlus/Menu/edit.jsp";
		 });
