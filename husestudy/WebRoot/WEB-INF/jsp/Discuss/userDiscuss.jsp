...
<body>
    ...
    <hr/>
        <div class="row-fluid">
            ...
            <div class="block">
                <div class="navbar navbar-inner block-header">
                    <div class="muted pull-left">Pagination shows your comments</div>
                </div>
                <div class="block-content collapse in">
                    <div class="span12">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
                            <s:iterator var="discussByUid" value = "pageBean.list" status="status">
                                <tr class="odd gradeX">
                                       <td><s:property value="#discussByUid.dcontent"/></td>
                                       <td><s:property value="%{getText('{0,date,yyyy-MM-dd HH:mm:ss}',{#discussByUid.ddate})}"/></td>
                                       <td><s:property value="#discussByUid.good"/></td>
                                       <td><s:property value="#discussByUid.bad"/></td>
                                       <td><s:property value="#discussByUid.works.wname"/></td>
                                       <td><s:property value="#discussByUid.user.username"/></td>
                                       <td><a href="${ pageContext.request.contextPath }/discuss_edit.action?did=<s:property value="#discussByUid.did"/>">
                                                <img src="${pageContext.request.contextPath}/admin/images/i_edit.gif" border="0" style="CURSOR: hand">
                                            </a>
                                       </td>
                                       <td><a href="${ pageContext.request.contextPath }/discuss_delete.action?did=<s:property value="#discussByUid.did"/>" onclick="return confirm('确定要删除吗？')">
        ...
        <div class="sixteen columns row textblock fullblog sideview">
            ...
            <div class="blogpages">
            <ul>
                 <s:if test="#discussByUid.did != null">
                    第<s:property value="pageBean.page"/>/<s:property value="pageBean.totalPage"/>页
                    <s:if test="pageBean.page != 1">
                        <a href="${ pageContext.request.contextPath }/discuss_findByUid.action?did=<s:property value="#discussByUid.did"/>&page=1" class="firstPage">&nbsp;</a>
                        <a href="${ pageContext.request.contextPath }/discuss_findByUid.action?did=<s:property value="#discussByUid.did"/>&page=<s:property value="pageBean.page-1"/>" class="previousPage">&nbsp;</a>
                    </s:if>
                    
                    <s:iterator var="i" begin="1" end="pageBean.totalPage">
                        <s:if test="pageBean.page != #i">
                            <a href="${ pageContext.request.contextPath }/discuss_findByUid.action?did=<s:property value="#discussByUid.did"/>&page=<s:property value="#i"/>"><s:property value="#i"/></a>
                        </s:if>
                        <s:else>
                    ...
                    <s:if test="pageBean.page != pageBean.totalPage">    
                        <a class="nextPage" href="${ pageContext.request.contextPath }/discuss_findByUid.action?did=<s:property value="#discussByUid.did"/>&page=<s:property value="pageBean.page+1"/>">&nbsp;</a>
                        <a class="lastPage" href="${ pageContext.request.contextPath }/discuss_findByUid.action?did=<s:property value="#discussByUid.did"/>&page=<s:property value="pageBean.totalPage"/>">&nbsp;</a>
                    </s:if>
                </s:if>    
            </ul>
            ...
            <!-- 添加一些查询和编辑操作的表单：bootstrap tables中版本冲突！ -->
            <%-- <%@ include file="../Discuss/userDiscussChild.jsp" %> --%>
