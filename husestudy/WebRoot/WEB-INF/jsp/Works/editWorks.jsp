	...
	<body>
		...
		<div class="block">
			<div class="navbar navbar-inner block-header">
				<div class="muted pull-left">编辑作品</div>
			</div>
			<div class="block-content collapse in">
				<div class="span12">
					<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/works_update.action" method="post" class="form-horizontal" enctype="multipart/form-data">
						<fieldset>
							<legend>作品编辑</legend>
							<div class="control-group">
								<label class="control-label" for="focusedInput">作品编号</label>
								<div class="controls">   <!-- 注释：将逐渐放入到隐藏的表单域中 -->
									<input class="input-xlarge focused" name="wid" id="userAction_save_do_logonName" disabled="disabled" type="text" value="<s:property value="model.wid"/>"/>  <s:hidden name="works.wid" id="wid"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="focusedInput">作品名称</label>
								<div class="controls">
									<input class="input-xlarge focused" name="wname"  value="<s:property value="model.wname"/>" id="userAction_save_do_logonName" type="text">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									 <div class="span12" id="content">
					                    <div class="row-fluid">
					                        <!-- block -->
						                   <%-- <textarea rows="15" cols="20"  name="wcontent" style="width:480px;height:310px;overflow:scroll;resize:none;" >
					                        ...
					                        <div class="block">
					                            ...
					                            <div class="block-content collapse in">
					                               <textarea id="ckeditor_standard" name="wcontent"><s:property value="model.wcontent"/></textarea>
					                            </div>
					                        </div>
        ...
        $(function() {
            ...
            $( 'textarea#ckeditor_full' ).ckeditor({width:'98%', height: '150px'});
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="file" name="upload" accept="image/*" value="${ pageContext.request.contextPath }/<s:property value="model.wimage"/>"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="focusedInput">作品视频</label>
								<div class="controls">
									<input type="file" name="uploadVedio" accept="video/*" value="${ pageContext.request.contextPath }/<s:property value="model.wvedio"/>"/>
								</div>
							</div>
							<div class="control-group">
